import TinyMerkleTree, { bitsToNum, convertProofToBits, formatForCircom, generatekeys, generateRandomNumber, getRandomNullifier, hashNums, NOTE, smolPadding, standardizeToPoseidon } from "@fifteenfigures/tiny-merkle-tree"
...
const big = BigInt(NOTE)
const small = BigInt(5e6)
export const amount = big + small
...
const leafNum = poseidon([dKeyBigInt, small])
